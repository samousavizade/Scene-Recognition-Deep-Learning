...
class NeuralNetworkTrainer:
    ...
    def train_net_with_hyper_parameters(self, configs: HyperParameterConfigs):
        ...
        part2_nn = Part2NN(num_classes)
        part2_nn = part2_nn.to(device)

        part2_nn = part2_nn.to(device)

        optimizer = optim.Adam(params=part2_nn.parameters(), lr=lr, weight_decay=weight_decay)
        ...
        # train model
        fine_tuned_trained_net, train_statistics = self.train_model(part2_nn,
