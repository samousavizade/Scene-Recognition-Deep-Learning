...
class NeuralNetworkTrainer:
    ...
    def train_net_with_hyper_parameters(self, configs: HyperParameterConfigs):
        ...
        part1_nn = Part1NN(num_classes)
        part1_nn = part1_nn.to(device)

        part1_nn = part1_nn.to(device)

        optimizer = optim.Adam(params=part1_nn.parameters(), lr=lr, weight_decay=weight_decay)
        ...
        # train model
        fine_tuned_trained_net, train_statistics = self.train_model(part1_nn,
